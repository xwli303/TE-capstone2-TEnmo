...
1: Create a database called `tenmo`
2: Connect to that db and exectue the `schema.sql` in your `tenmo` database.
3: Exectue the `user.sql` in your `tenmo` database.

1. Create a database called `tenmo`
2. Connect to that db and exectue the `schema.sql` script in your `tenmo` database.
3. Execute the `user.sql` script in your `tenmo` database.
